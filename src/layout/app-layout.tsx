...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'case-manager', 'fraud-investigator', 'compliance-officer', 'end-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Frauds', path: '/frauds', entity: 'fraud', service: AccessServiceEnum.PROJECT, icon: FiAlertTriangle },
    { name: 'Policies', path: '/policies', entity: 'policy', service: AccessServiceEnum.PROJECT, icon: FiFileText },
