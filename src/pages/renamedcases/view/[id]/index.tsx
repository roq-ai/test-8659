        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Case Name" text={data?.case_name} />

                <FormListItem label="Case Type" text={data?.case_type} />

                <FormListItem
                  label="Date Reported"
                  text={
                    data?.date_reported ? format(parseISO(data?.date_reported as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
