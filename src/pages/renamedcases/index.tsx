...
export function RenamedcaseListPage(props: RenamedcaseListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRenamedcases({
        ...
        order: params.order,
        searchTermKeys: ['case_name.contains', 'case_type.contains', 'status.contains', 'description.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'case_name', header: 'Case Name', accessorKey: 'case_name' },
    { id: 'case_type', header: 'Case Type', accessorKey: 'case_type' },
    {
      id: 'date_reported',
      header: 'Date Reported',
      accessorKey: 'date_reported',
      cell: ({ row: { original: record } }: any) =>
        record?.date_reported ? format(parseISO(record?.date_reported as unknown as string), 'dd-MM-yyyy') : '',
    },
