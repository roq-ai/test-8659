  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="TEST: Unleashing the power of efficiency in case management, handling policy violations and frauds with precision and transparency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1510915228340-29c85a43dcfe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmF1ZHxlbnwwfHx8fDE2OTU0NzI5Mjd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`TEST: Unleashing the power of efficiency in case management, handling policy violations and frauds with precision and transparency.`}
            </Text>
            <Box
