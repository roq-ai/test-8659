            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('compliance', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/compliances/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Compliance Name" text={data?.compliance_name} />

                <FormListItem label="Compliance Type" text={data?.compliance_type} />

                <FormListItem
                  label="Date Implemented"
                  text={
                    data?.date_implemented
                      ? format(parseISO(data?.date_implemented as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
