...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'CaseCreated.create': {
    roles: ['administrator', 'case-manager', 'fraud-investigator', 'compliance-officer'],
    key: 'caseId',
    tenantPath: [],
    userPath: [],
  },
  'FraudInvestigationInitiated.create': {
    roles: ['administrator', 'fraud-investigator'],
    key: 'investigationId',
    tenantPath: [],
    userPath: [],
  },
  'ComplianceIssueReported.create': {
...
const tenantRoles: string[] = ['administrator', 'case-manager', 'fraud-investigator', 'compliance-officer', 'end-user'];
